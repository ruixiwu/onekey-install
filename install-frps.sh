...
export aliyun_download_url="https://code.aliyun.com/ruixiwu/onekey-install/tree/master"
...
str_install_shell="https://code.aliyun.com/ruixiwu/onekey-install/raw/master/install-frps.sh"
shell_update(){
    fun_clangcn "clear"
